# Common Repository for the Workshop *Towards New Horizons in Digital Humanities: Multimodal Approaches for Visual Media*
...
* Experimenting with [PixPlot](https://github.com/YaleDHLab/pix-plot/) visualisations (fork with added functionality [here](../pix-plot))
